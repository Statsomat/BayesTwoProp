...
if (params$user_selection_function_param == 1) {
  if (final_results$Posterior[3] < 0) {
    comparison = "lower"
  } else {
    comparison = "higher"
  }
  cat("\\(\\theta_1 - \\theta_2\\)")
  cat("=", final_results$Posterior[3], " suggests that, on average, the probability of ", 
  ...
  if (final_results$Posterior[3] < 1) {
    comparison = "lower"
  } else {
    comparison = "higher"
  }
  cat("\\(\\frac{\\theta_1}{\\theta_2}\\)")
  cat("=", final_results$Posterior[3], " suggests that the relative probability of ",
  ...
  cat("\\(1 - \\frac{\\theta_1}{\\theta_2}\\)")
  cat("=", final_results$Posterior[3], " suggests the proportionate reduction in the probability of ",
      name_outcome, " in the group of ", name_exposure,
