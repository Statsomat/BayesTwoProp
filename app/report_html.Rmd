...
cat("If the effective sample size is greater than 10.000 Kruschke recommends using the 95% interval for an estimation with high precision. For smaller effective sample sizes the 89% intervals are deemed to be more stable (Kruschke, John K., Doing Bayesian Data Analysis, Academic Press, 2015).")
```
