...
cat("<br>", fill=TRUE)
<<<<<<< Updated upstream
cat("Let $$(Y_1,Y_2) \\sim f(Y_1,Y_2 \\ | \\ \\theta_1, \\theta_2)\\$$", fill = TRUE)
...
## Despriction of the prior distribution
...
## Despriction of the posterior distribution
