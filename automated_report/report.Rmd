...
## It should look like the second row from page 167 DDBA
...
cat("\n### Equation", fill=TRUE)
# Insert latex equation for the posterior distribution 
```

```{r posterior_plot, eval=eval, dev="cairo_pdf", results='asis'}
cat("### Posterior Distribution Plot", fill=TRUE)
...
if (is.null(rope_user)==TRUE){
  ...
  # ROPE limits and decisions. If using a continuous-parameter posterior distribution as the basis for decision, state and justify the limits of the ROPE and the required probability mass. 
}
```
