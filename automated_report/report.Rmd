...
s1 = sum(df[outcome]==presence_outcome & df[exposure]==presence_exposure)
n1 = sum(df[exposure]==presence_exposure)
s2 = sum(df[outcome]== presence & df[exposure]!=presence_exposure)
n2 = sum(df[exposure]!=presence_exposure)
