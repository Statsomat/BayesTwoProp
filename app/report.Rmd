...
params:
  ...
  decimal: NA
  enc_guessed: NA
  presence_outcome: Outcome variable of interest
  presence_exposure: Exposure variable of interest
  outcome: Outcome column from selection
  exposure: Exposure column from selection
  dataTableInput: NA 
  exposurename: Name of Exposure Variable
  outcomename:  Name of Outcome Variable
header-includes:
   - \usepackage{xcolor}
