...
if(a1!=0.5 | b1!=0.5 | a2!=0.5 | b2!=0.5){
  ...
  if(a1 == a2 & a1 == b1 & a1 == b2){
    cat("In this case, all parameters were chosen to be the same. This means that it was assumed that little or no information about the parameters to be estimated was known in advance. The maximum of the prior distribution is therefore at $(0.5, 0.5)$.")
  }else{
    if(a1 >1 & b1 > 1){
    ...
    cat(paste0("In this case, not all parameters were chosen to be the same. This means that it was assumed that there was information about the parameters in advance. The prior is peaked in (",t1_m,", ",t2_m,")."))
  }
