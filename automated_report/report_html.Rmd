...
cat("<br>", fill=TRUE)
cat(paste0("\\begin{align} L \\Big( \\theta_1= \\frac{", s1, "}{", n1, "}, \\theta_2= \\frac{", s2, "}{", n2, "} \\ \\Big | \\ y_1=", s1, ", y_2=", s2, " \\Big) &=", round(L1,4),", \\\\[1em] L(\\theta_1= 0.5, \\theta_2= 0.5 \\ | \\  y_1=", s1, ", y_2=", s2, ") &=", round(L2,4),".\\end{align}"), fill=TRUE)
cat("<br>", fill=TRUE)
