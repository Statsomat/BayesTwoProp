source("automated_report/DBDA/DBDA2E-utilities.R")  # Load definitions of graphics functions etc.
source("automated_report/DBDA/BernBeta.R")          # Load the definition of the BernBeta function
