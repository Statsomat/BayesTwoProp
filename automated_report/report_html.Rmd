...
# Begrenzung der Dichtewerte für eine bessere Farbskalierung
pTheta1Theta2[is.infinite(pTheta1Theta2)] <- NA  # Ersetzt unendliche Werte durch NA
pTheta1Theta2 <- pmin(pTheta1Theta2, quantile(pTheta1Theta2, 0.99, na.rm = TRUE))  # Beschränkt auf das 99. Perzentil
