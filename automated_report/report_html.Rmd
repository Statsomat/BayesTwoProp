...
cat("The likelihood function is a function of $(\\theta_1, \\theta_2 )$, that describes the plausibility of $(Y_1,Y_2)=(y_1,y_2)$ with different $(\\theta_1, \\theta_2 )$.The likelihood function should not be confused as a probability function.", fill = TRUE)
cat("<br>", fill=TRUE)
cat("$$(Y_1,Y_2) $$")
cat("<br>", fill=TRUE)
#Likelihood formula of D given theta_1 and theta_2
cat("$$f(y_1,y_2)=P(Y_1=y_1,Y_2=y_2 | \\theta_1, \\theta_2)=P(Y_1=y_1|\\theta_1, \\theta_2) \\cdot P(Y_2=y_2|\\theta_1, \\theta_2)$$")
cat("<br>", fill=TRUE)
cat("$$=P(Y_1=y1|\\theta_1) \\cdot P(Y_2=y2|\\theta_2)$$", fill=TRUE)
cat("<br>", fill=TRUE)
cat("$$= \\begin{pmatrix} n_1 \\\\ y_1 \\end{pmatrix} \\theta_1^{y_1}(1-\\theta_1)^{n_1 - y_1} \\cdot  \\begin{pmatrix} n_2 \\\\ y_2 \\end{pmatrix} \\theta_2^{y_2}(1-\\theta_2)^{n_2 - y_2}$$", fill=TRUE)
cat("<br>", fill=TRUE)
cat("The likelihood function $L: [0,1] \\times [0,1] \\to [0, \\infty)$ with", fill = TRUE)
cat("<br>", fill=TRUE)
...
cat("Consider our data:",fill=TRUE)
cat(paste0("$$n_1=", n1, ", n_2=", n2, ", y_1=", s1, ", y_2=", s2, "$$"), fill=TRUE)
cat("<br>", fill=TRUE)
...
cat("<br>", fill=TRUE)
cat("Examples:", fill=TRUE)
cat("<br>", fill=TRUE)
cat(paste0("Then $$L(\\theta_1= \\frac{", s1, "}{n_1}, \\theta_2= \\frac{", s2, "}{n_2} | y_1=", s1, ", y_2=", s2, ") =---$$"), fill=TRUE)
cat("<br>", fill=TRUE)
cat(paste0("Then $$L(\\theta_1= 0 \\cdot 5, \\theta_2= 0 \\cdot 5 | y_1=", s1, ", y_2=", s2, ") =---$$"), fill=TRUE)
cat("<br>", fill=TRUE)
...
cat("$$P(Y_1=y_1 | \\theta_1 ) = \\begin{pmatrix} n_1 \\\\ y_1 \\end{pmatrix} \\theta_1^{y_1}(1-\\theta_1)^{n_1 - y_1}$$", fill = TRUE)
cat("<br>",fill=TRUE)
#Marginal distribution of D_2 given theta_2
cat("$$P(Y_2=y_2 | \\theta_2) = \\begin{pmatrix} n_2 \\\\ y_2 \\end{pmatrix} \\theta_2^{y_2}(1-\\theta_2)^{n_2 - y_2}$$", fill = TRUE)
