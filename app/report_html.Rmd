...
cat(paste("Number of Observations with a present Outcome (",params$outcome, " is equal to ", params$presence_outcome ,") and present Exposure (",params$exposure ," is equal to ",params$presence_exposure , "): ", params$n_exposure1_outcome1),fill=TRUE)
cat("<br>",fill=TRUE) 
cat(paste("Number of Observations with present Exposure (",params$exposure ," is equal to ",params$presence_exposure ,") : ",params$n_exposure1),fill=TRUE)
cat("<br>",fill=TRUE) 
cat(paste("Number of Observations with a present Outcome (",params$outcome, " is equal to ", params$presence_outcome ,") and without Exposure (",params$exposure ," is not equal to ",params$presence_exposure ,") : ",params$n_exposure0_outcome1),fill=TRUE)
cat("<br>",fill=TRUE) 
cat(paste("Numbers of Observations without Exposure(",params$exposure ," is not equal to ",params$presence_exposure ,"): ",params$n_exposure0),fill=TRUE)
cat("<br>",fill=TRUE) 
```
...
&= beta(\\theta_1 \\vert \\underbrace{",a1,"+",n_exposure1_outcome1,"}_{",a1+n_exposure1_outcome1,"},\\underbrace{",b1,"+",n_exposure1,"-",n_exposure1_outcome1,"}_{",b1+n_exposure1-n_exposure1_outcome1,"}) \\cdot beta(\\theta_2 \\vert \\underbrace{",a2,"+",n_exposure0_outcome1,"}_{",a2+n_exposure0_outcome1,"},\\underbrace{",b2,"+",n_exposure0,"-",n_exposure0_outcome1,"}_{",b2+n_exposure0-n_exposure0_outcome1,"}) \\end{align}"))
```
