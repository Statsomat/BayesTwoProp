...
fig <- fig %>% add_surface(hovertemplate = paste0('\u03b8\u2081: %{x}<br>', '\u03b8\u2082: %{y}<br>', 'p(D | \u03b8\u2081, \u03b8\u2082): %{z}<extra></extra>')) #colorscale = list(c(0, 1), c("#2fa42d", "#396e9f")), 
...
fig <- fig %>% layout(legend=list(title=list(text='<b> p(D | \u03b8\u2081, \u03b8\u2082) </b>')))
