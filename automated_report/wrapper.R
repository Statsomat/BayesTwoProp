...
# Data as a file 
filename <- "/Users/johannesepe/Desktop/Studium/BayesTwoProp/automated_report/datasets/biontech.csv" 
decimal <- "."
...
##############################################################
rmarkdown::render("/Users/johannesepe/Desktop/Studium/BayesTwoProp/automated_report/report_html.Rmd", params = list(
  filename = filename,
  decimal = decimal,
  data =data,
  data = data,
