...
barplot(table(out_vec)/total, ylim=c(0,1), ylab= "Percentage of total Observations", col=c("#2fa42d","#396e9f")) #main = paste("Barplot of Outcome", params$outcome),

barplot(table(exp_vec)/total,ylim=c(0,1), ylab ="Percentage of total Observations", col=c("#2fa42d","#396e9f"))#, main= paste("Barplot of Exposure", params$exposure)


out_vec_exp1 <- out_vec[exp_vec==params$presence_exposure]
barplot(table(out_vec_exp1)/total,ylim=c(0,1), ylab ="Percentage of total Observations", col=c("#2fa42d","#396e9f"))#, main= paste("Barplot of Outcome with present Exposure (", params$outcome, " with ", params$exposure,"=",params$presence_exposure, ")")
