...
if (params$user_selection_function_param == 1) {
  ...
  cat("\\(\\theta_1 - \\theta_2\\)")
  cat("=", a3$posterior[3], " suggests that, on average, the probability of ", 
      ...
      HDI of", round(b$CI_low, 3), "to ", round(b$CI_high, 3), "indicates that there is
      a 95% probability that the true difference between infection probabilities ")
  cat("\\(\\theta_1 - \\theta_2\\)")
  cat(" lies within this interval.")
  if (b$CI_high > 0 && b$CI_low < 0) {
  ...
  cat("\\(\\frac{\\theta_1}{\\theta_2}\\)")
  cat("=", a3$posterior[3], " suggests that the relative probability of ",
      ...
      in the estimate. The HDI of ", round(b$CI_low, 3), " to ", round(b$CI_high, 3),
      " indicates that there is a 95% probability that the true ratio between ", name_outcome, "
      probabilities ")
  cat("\\(\\frac{\\theta_1}{\\theta_2}\\)")
  cat(" lies within this interval.")
  if (b$CI_high > 1 && b$CI_low < 1) {
  ...
  cat("\\(1 - \\frac{\\theta_1}{\\theta_2}\\)")
  cat("=", a3$posterior[3], " suggests the proportionate reduction in the probability of ",
      name_outcome, " in the group of ", name_exposure,
      ...
      The HDI of ", round(b$CI_low, 3), " to ", round(b$CI_high, 3), 
      " indicates that there is a 95% probability that the true difference between 1 
      and the ratio of infection probabilities ")
  cat("\\(1 - \\frac{\\theta_1}{\\theta_2}\\)")
  cat(" lies within this interval.")
  if (b$CI_high > 0 && b$CI_low < 0) {
    cat(" Since this interval includes 0, it means that the evidence is inconclusive
